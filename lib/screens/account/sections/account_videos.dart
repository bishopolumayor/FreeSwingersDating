...
class AccountVideo extends StatefulWidget {
  const AccountVideo({super.key});

  @override
  State<AccountVideo> createState() => _AccountVideoState();
}

class _AccountVideoState extends State<AccountVideo> {
  ...
  void initializeMedia() async {
    ...
    List<String> videos = mediaData.where((item) => isVideo(item)).toList();
