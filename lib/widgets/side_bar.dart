...
class SideBar extends StatefulWidget {
  ...
  const SideBar({super.key, required this.isLoginMode});
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Container(
          width:
              isNotWidest ? Dimensions.widthRatio(500) : Dimensions.widthRatio(360),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      // icon
                      Container(
                        width: Dimensions.widthRatio(15),
                        height: Dimensions.widthRatio(15),
                        decoration: const BoxDecoration(
              ...
              if(_isLoading)
                 Center(
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        height: isMobileView ? 100 : 180,
                      ),
                      const BarLoadingAnimation(),
                    ],
                  ),
                ),
            ],
